    ...
    <div className="relative">
      ...
      <div className=" pt-[2rem] xsm:pt-[5rem] flex items-center justify-center ">
        <div className="bg-white w-full pt-2 shadow-md overflow-hidden">
          ...
          >
            {/* Overlay Content */}
            <div className="absolute text-sm xsm:text-xl md:text-2xl mt-0 md:mt-3 lg:mt-9 leading-snug xsm:leading-tight lg:leading-snug text-customGray inset-0 flex flex-col font-domine items-start pl-3 lg:pl-14 md:pl-5 lg-items-center bg-opacity-20 max-w-[6rem], xsm:max-w-[30rem] md:max-w-[19rem] lg:max-w-[23rem] xl:max-w-[30rem]">
              <p>
              ...
              <Link href="/sign-in" className="mt-3 xsm:mt-6   md:mt-3 lg:mt-6">
                <button
                  type="button"
                  className="bg-customPink border-darkPink hover:bg-darkPink text-white font-domine lg:mt-9 py-4 px-12 md:py-2.5 lg:py-4 rounded-xl shadow-lg"
                >
                  Get Started
                </button>
              </Link>
